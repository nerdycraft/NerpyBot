...
class TestVoteButton:
    ...
    async def test_message_button_disabled_after_applicant_notified(self, review_view, mock_bot, db_session):
        ...
        from modules.application.views import update_review_embed

        await update_review_embed(mock_bot, review_channel_id=REVIEW_CHANNEL_ID, review_message_id=REVIEW_MSG_ID)
