...
export const de: typeof en = {
  ...
  nav: {
    ...
    items: {
      ...
      twitch_notifications: "Twitch-Benachrichtigungen",
    },
    sidebar: {
  ...
  tabs: {
    ...
    operator_modules: {
      ...
      load: "Laden",
      sync_title: "Befehlssync",
      sync_desc:
        "Synchronisiert Slash-Befehle mit der Discord-API. Globaler Sync nach dem Hinzufügen oder Entfernen von Modulen. Server-spezifische Modi eignen sich zum Testen vor dem globalen Ausrollen.",
      sync_mode_label: "Modus",
      sync_mode_global: "Global — alle Befehle weltweit synchronisieren",
      sync_mode_local: "Zum Server — Befehle auf einen Server übertragen",
      sync_mode_copy: "Kopieren — globale Befehle auf einen Server kopieren",
      sync_mode_clear: "Löschen — serverspezifische Überschreibungen entfernen",
      sync_guild_label: "Zielserver",
      sync_guild_placeholder: "Server auswählen…",
      sync_button: "Sync",
      sync_syncing: "Synchronisieren…",
      sync_success: "{count} Befehle synchronisiert",
      sync_cleared: "Befehle vom Server gelöscht",
    },
    ...
    operator_dashboard: {
      title: "Bot-Status",
      desc: "Live-Metriken, Bot-Berechtigungen und Fehlersteuerung.",
      tab_health: "Status",
      tab_permissions: "Bot-Berechtigungen",
      tab_error_control: "Fehlersteuerung",
      live: "Live",
      not_live: "Verbinde…",
      ...
      permissions_desc:
        "Bot-Berechtigungen auf allen Servern prüfen. Abonniere eine DM, wenn beim Neustart Berechtigungen fehlen.",
      permissions_loading: "Berechtigungen werden geprüft…",
      permissions_empty: "Keine Server gefunden.",
      permissions_col_guild: "Server",
      ...
      error_control_desc: "Fehler-DM-Benachrichtigungen verwalten und Debug-Logging umschalten.",
      error_status_title: "Benachrichtigungsstatus",
      error_active: "Aktiv — Benachrichtigungen aktiviert",
      error_suppressed: "Unterdrückt — noch {remaining}",
      error_buckets_title: "Aktuelle Fehlereimer",
      error_buckets_empty: "Noch keine Fehler erfasst.",
      error_bucket_last: "zuletzt vor {ago}",
      error_bucket_suppressed: "{count} unterdrückt",
      error_suppress_title: "Benachrichtigungen unterdrücken",
      error_suppress_duration_label: "Dauer",
      error_suppress_duration_placeholder: "z. B. 30m, 2h, 1d",
      error_suppress_button: "Unterdrücken",
      error_suppressing: "Unterdrücken…",
      error_resume_button: "Benachrichtigungen fortsetzen",
      error_resuming: "Fortsetzen…",
      debug_title: "Debug-Logging",
      debug_enabled: "Debug-Logging ist derzeit aktiviert",
      debug_disabled: "Debug-Logging ist derzeit deaktiviert",
      debug_toggle_button: "Debug umschalten",
      debug_toggling: "Umschalten…",
    },
  ...
  twitch: {
    tab_subtitle: "Benachrichtigungen wenn Streamer live gehen",
    empty: "Keine Twitch-Benachrichtigungen konfiguriert.",
    add_button: "Stream-Monitor hinzufügen",
    streamer_label: "Twitch-Benutzername",
    streamer_hint: "Der Twitch-Loginname des Streamers (wird beim Speichern geprüft)",
    channel_label: "Discord-Kanal",
    channel_hint: "Wo Benachrichtigungen gepostet werden",
    message_label: "Benutzerdefinierte Nachricht (optional)",
    message_hint: "Leer lassen für Standardbenachrichtigung",
    notify_offline_label: "Auch benachrichtigen wenn Stream endet",
    active_badge: "Aktiv",
    offline_yes: "Ja",
    offline_no: "Nein",
