export const en = {
  ...
  tabs: {
    ...
    operator_modules: {
      ...
      load: "Load",
      sync_title: "Command Sync",
      sync_desc:
        "Sync slash commands with Discord's API. Use global sync after adding or removing modules. Guild-specific modes are useful for testing before pushing globally.",
      sync_mode_label: "Mode",
      sync_mode_global: "Global — sync all commands worldwide",
      sync_mode_local: "Sync to guild — push commands to one guild",
      sync_mode_copy: "Copy to guild — copy global commands to one guild",
      sync_mode_clear: "Clear from guild — remove guild-specific overrides",
      sync_guild_label: "Target Guild",
      sync_guild_placeholder: "Select guild…",
      sync_button: "Sync",
      sync_syncing: "Syncing…",
      sync_success: "{count} commands synced",
      sync_cleared: "Commands cleared from guild",
    },
    ...
    operator_dashboard: {
      title: "Bot Health",
      desc: "Live metrics, bot permissions, and error control.",
      tab_health: "Health",
      tab_permissions: "Bot Permissions",
      tab_error_control: "Error Control",
      live: "Live",
      not_live: "Connecting…",
      ...
      permissions_desc:
        "Check bot permissions across all servers. Subscribe to receive a DM when the bot restarts and finds missing permissions.",
      permissions_loading: "Checking permissions…",
      permissions_empty: "No guilds found.",
      permissions_col_guild: "Guild",
      ...
      error_control_desc: "Manage error DM notifications and toggle debug logging.",
      error_status_title: "Notification Status",
      error_active: "Active — notifications enabled",
      error_suppressed: "Suppressed — {remaining} remaining",
      error_buckets_title: "Recent Error Buckets",
      error_buckets_empty: "No errors tracked yet.",
      error_bucket_last: "last {ago} ago",
      error_bucket_suppressed: "{count} suppressed",
      error_suppress_title: "Suppress Notifications",
      error_suppress_duration_label: "Duration",
      error_suppress_duration_placeholder: "e.g. 30m, 2h, 1d",
      error_suppress_button: "Suppress",
      error_suppressing: "Suppressing…",
      error_resume_button: "Resume Notifications",
      error_resuming: "Resuming…",
      debug_title: "Debug Logging",
      debug_enabled: "Debug logging is currently enabled",
      debug_disabled: "Debug logging is currently disabled",
      debug_toggle_button: "Toggle Debug",
      debug_toggling: "Toggling…",
    },
  ...
  twitch: {
    tab_subtitle: "Get notified when streamers go live",
    empty: "No Twitch notifications configured.",
    add_button: "Add Stream Monitor",
    streamer_label: "Twitch Username",
    streamer_hint: "The streamer's Twitch login name (validated on save)",
    channel_label: "Discord Channel",
    channel_hint: "Where notifications will be posted",
    message_label: "Custom Message (optional)",
    message_hint: "Leave empty for default notification",
    notify_offline_label: "Also notify when stream ends",
    active_badge: "Active",
    offline_yes: "Yes",
    offline_no: "No",
